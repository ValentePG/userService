insert into tbl_usuario (id,email,first_name,last_name) values (1,'yusuke@gmail.com','yusuke','urameshi');
insert into tbl_usuario (id,email,first_name,last_name) values (2, 'hiei@gmail.com','hiei','dragon');
